...
/* USER CODE BEGIN PV */
//following variables for testing purposes only
double *d_dutyx,*d_dutyy,*d_dutyz,*f_dutyx,*f_dutyy,*f_dutyz;
/* USER CODE END PV */
...
int main(void)
{
  ...
  set_desired_motory(70,1);
  set_desired_motorz(30,1);

  HAL_Delay(5000);

  set_desired_motorx(80,1);
    set_desired_motory(40,1);
    set_desired_motorz(32,1);
